...
const BookingCheckout = () => {
    ...
    if (!error) {
      try {
        const response = await axios.post(
          "http://localhost:8800/api/payment/booking/stripe",
          {
  ...
  const handlePayPalPayment = (orderID, details) => {
    axios
      .post(
        "http://localhost:8800/api/payment/booking/paypal",
        {
          orderID,
          ...
          <div className="pt-[100px] md:pt-4 flex flex-col items-center justify-center w-full p-6 bg-custom-green backdrop-blur-[10px]">
            ...
            >
              ...
              <p className="font-PPNeueMontreal400 mt-2">
                ...
                $15 , you can create your account (one per person only). After
                that, there are no additional costs, except for the services
                provided. Welcome to our community!
              </p>
            </div>
